 ...
 */
public class MyPetriSim implements Cloneable, Serializable {
    ...
    public MyPetriSim(String id, PetriNet net, StateTime timeState) {
        this(net, new StateTime());
     ...
     */
    public MyPetriSim(PetriNet net, JSlider delaySlider) {
        this(net);
    ...
    @Override
    public MyPetriSim clone() throws CloneNotSupportedException{ //added 29.11.2017 by Inna

        super.clone();

        return new MyPetriSim(this.getNet().clone());
    }
    ...
    public static Comparator<MyPetriSim> getComparatorByPriority() {
        return new Comparator<MyPetriSim>() {
            @Override
            public int compare(MyPetriSim o1, MyPetriSim o2) {
                if (o1.getPriority() < o2.getPriority()) {
                    return 1;
                } else if (o1.getPriority() == o2.getPriority()) {
                    return 0;
    ...
    public static Comparator<MyPetriSim> getComparatorByNum() {
        return new Comparator<MyPetriSim>() {
            @Override
            public int compare(MyPetriSim o1, MyPetriSim o2) {
